...
Ako prvý si uvedieme príkaz for. Vo väčšine jazykov sme zvyknutý na zápis ako v prvom a treťom príklade : 
Pri Bashi je syntax nasledovná : 
\begin{algorithm}
	\begin{minted}{php}
...
\end{algorithm}
\linebreak
\indent Avšak syntax jazyka sa učí tažšie nakoľko používa rôzne prepínače, ktoré novému používateľovi nemusia byť sprvu jasné. 
...
\begin{center}
	\begin{table}[htbp]
		\begin{tabular}{|p{2.5cm}|p{14cm}|}
			...
			\hline
			\textbf{Výstp} & Textový reťazec informujúci o úspešnosti výmeny.\\
			\hline
			\textbf{Chyba} & Výpíše chybu do stderr.\\
			\hline
		\end{tabular}
		\label{table:1}
