...
\subsection{Hlavná trieda aplikácie}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.7]{img/initialization.jpg}
	\caption{Activita spustenia aplikácie}
	\label{fig:test}
\end{figure}
